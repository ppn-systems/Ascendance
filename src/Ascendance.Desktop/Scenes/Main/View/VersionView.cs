...
public sealed class VersionView : RenderObject
{
    ...
    protected override Drawable GetDrawable() => _versionText;
    ...
    private void POSITION_TEXT()
    {
        ...
        System.Single y = PaddingTop;

        _versionText.Position = new Vector2f(x, y);
    }
